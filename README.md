...
1. Create a Vendor
2. Create a Product linked to that Vendor
3. Create a Course linked to the Product
4. Create a Certification linked to the Course
5. Validate the hierarchy through mapping APIs and Swagger/Postman
